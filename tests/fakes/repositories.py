...
from app.storage.interfaces import InboxEventsRepoIface, IncidentsRepoIface, OutboxRepoIface
...
class InboxEventsRepoFake(InboxEventsRepoIface):
    ...
    async def get_by_provider_id(self, provider: str, provider_event_id: str) -> InboxEvent | None:
